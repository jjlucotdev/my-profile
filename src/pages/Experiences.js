...
export default function Experiences() {
	...
	const toggleShowTabs = () => {
		...
		console.log(showTabs); // Add this line for debugging
	};

	return (
		<MDBContainer className="section-experience text-left" >
			<MDBRow>
				<MDBCol size="12" className="d-md-none mb-3">
					<MDBBtn onClick={toggleShowTabs} block>
						{showTabs ? 'Hide Sections' : 'Show Sections'}
					</MDBBtn>
					<MDBCollapse open={showTabs}>
							...
							<section className="py-5">
								<ul className="timeline-with-icons">
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Bachelor of Science in Information Technology</h5>
										<p className="mb-2 fw-bold">STI West Negros University | 2019</p>
									...
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Zuitt Web Developer Program (Main Course Package)</h5>
										<p className="text-muted mb-2 fw-bold">Zuitt Bootcamp | 2024</p>
										<p className="text-muted">
							...
							<section className="py-5">
								<ul className="timeline-with-icons">
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Capstone Project</h5>
										<p className="text-muted mb-2 fw-bold">STI West Negros University | 2019</p>
									...
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">On-The-Job Training</h5>
										<p className="text-muted mb-2 fw-bold">Tinkertech Inc. | January - March 2019</p>
									...
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Zuitt Bootcamp Capstone Projects</h5>
										<p className="text-muted mb-2 fw-bold">Zuitt Bootcamp | Feb 2024 - June 2024</p>
							...
							<section className="py-5">
								<ul className="timeline-with-icons">
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Junior Programmer</h5>
										<p className="text-muted mb-2 fw-bold">GCC group of companies | Oct. 2019 - Oct. 2020</p>
									...
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Café Manager</h5>
										<p className="text-muted mb-2 fw-bold">Four J’s Cafe | Mar. 2021 - Feb. 2024</p>
							...
							<section className="py-5">
								<ul className="timeline-with-icons">
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">ICT Olympics Java Competition Champion</h5>
										<p className="text-muted mb-2 fw-bold">Issued by Programmers Guild · Oct 2018</p>
										<p className="text-muted">Associated with STI West Negros University</p>
										<p className="text-muted">
									...
									<li className="timeline-item mb-5">
										...
										<h5 className="fw-bold">Java Programmer Speaker</h5>
										<p className="text-muted mb-2 fw-bold">Issued by Programmers Guild · Aug 2018</p>
										<p className="text-muted">Associated with STI West Negros University</p>
										<p className="text-muted">
